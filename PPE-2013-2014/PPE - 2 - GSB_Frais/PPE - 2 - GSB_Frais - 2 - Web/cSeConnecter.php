 ...
 */
  ...
  if ($etape=='validerConnexion') { // un client demande à s'authentifier
	...
	$lgUser = verifierInfosConnexion($idConnexion, $login, $mdp, "comptable") ;
	// si l'id utilisateur a été trouvé, donc informations fournies sous forme de tableau
	if ( is_array($lgUser) ) { 
	  affecterInfosConnecte($lgUser["id"], $lgUser["login"], "comptable");
	}
	else {
		$lgUser = verifierInfosConnexion($idConnexion, $login, $mdp, "visiteur") ;
		// si l'id utilisateur a été trouvé, donc informations fournies sous forme de tableau
		if ( is_array($lgUser) ) { 
		  affecterInfosConnecte($lgUser["id"], $lgUser["login"], "visiteur");
		}
		else {
