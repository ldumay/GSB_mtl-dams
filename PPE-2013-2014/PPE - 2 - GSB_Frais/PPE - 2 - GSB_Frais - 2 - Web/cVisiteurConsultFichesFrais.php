 ...
 */
  ...
  require($repInclude . "_sommaire.visit.inc.php");
...
?>
  ...
  <div id="contenu">
      ...
      <p>
        ...
        <select id="lstMois" name="lstMois" title="Sélectionnez le mois souhaité pour la fiche de frais" onChange="document.forms.toto.submit()" >
            <?php
            ...
            ?>
<?php echo ($moisSaisi == $moi ? 'selected="selected"' : ''); ?>
